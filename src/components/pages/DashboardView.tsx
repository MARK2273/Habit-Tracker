    ...
    <div className="animate-in fade-in duration-500">
      <header className="mb-12 flex items-end justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-right">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-on-surface-variant mb-1">Daily Progress</p>
            <div className="flex items-center gap-3">
              <div className="w-32 h-1.5 bg-surface-low rounded-full overflow-hidden">
                <div 
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <span className="font-semibold">Add a new ritual</span>
        </button>
      </section>

      {habits.length > 0 && (
        <section className="mt-16 p-8 glass-card border border-outline-variant/10 flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-secondary/10 flex items-center justify-center text-secondary mb-4 shadow-inner">
            <Sparkles size={32} />
          </div>
          <h3 className="text-xl font-bold text-on-surface mb-2">Build Your Digital Sanctuary</h3>
